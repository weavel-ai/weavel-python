...
class Weavel:
    ...
    async def aoptimize_prompt(
        ...
        await self._worker.aoptimize_ape(
            dataset_name=dataset_name,
            prompt_name=prompt_name,
            version=version,
            input_vars=input_vars,
    ...
    def schedule_ape(
        ...
        return self._worker.schedule_ape(
            prompt_name=prompt_name,
            dataset_name=dataset_name,
            interval=interval,
    ...
    async def aschedule_ape(
        ...
        return await self._worker.aschedule_ape(
            prompt_name=prompt_name,
            dataset_name=dataset_name,
            interval=interval,
            trigger_threshold=trigger_threshold,
    ...
    def list_ape_schedule(
        ...
        return self._worker.list_ape_schedule(
            prompt_name=prompt_name,
            dataset_name=dataset_name,
        )
    ...
    async def alist_ape_schedule(
        ...
        return await self._worker.alist_ape_schedule(
            prompt_name=prompt_name,
            dataset_name=dataset_name,
        )
