...
class Worker:
    ...
    def capture_log(
        ...
        Args:
            ...
            reason_log_id: The reason log identifier.
        """
        if created_at.tzinfo is None or created_at.tzinfo.utcoffset(created_at) is None:
            created_at = created_at.astimezone(timezone.utc)
        else:
    ...
    def send_requests(
        self,
        requests: List[
            Union[OpenSessionBody, CaptureLogBody, CaptureObservationBody]
        ],
    ):
        """
        ...
        Args:
            requests (List[Union[OpenSessionBody, CaptureLogBody, CaptureObservationBody]]):
